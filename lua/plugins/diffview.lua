    ...
    require("diffview").setup({
      ...
      keymaps = {
        ...
        view = {
          ...
          { "n", "<leader>gdf", function() require("diffview.actions").focus_files() end,                { desc = "Bring focus to the file panel" } },
          { "n", "<leader>gdT", function() require("diffview.actions").toggle_files() end,               { desc = "Toggle the file panel" } },
